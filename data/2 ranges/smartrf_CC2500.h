...
#define SMARTRF_SETTING_FREQ1      0x58 //0x93
#define SMARTRF_SETTING_FREQ0      0x9d //0xB1
...
#define SMARTRF_SETTING_MDMCFG1    0x22 //0x22	// channel spacing exponent 0x03?
#define SMARTRF_SETTING_MDMCFG0    0x7A //0xF8  // Channel spacing: Fxosc/2^18 (~99.182) * (256*mantissa) ^ exp . Desired 333KHz.
