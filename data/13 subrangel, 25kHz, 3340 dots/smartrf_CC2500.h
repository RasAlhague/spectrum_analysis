...
#define SMARTRF_SETTING_IOCFG2           0x29      /*gdo2output pin configuration */
#define SMARTRF_SETTING_IOCFG1           0x2E      /*gdo1output pin configuration */
#define SMARTRF_SETTING_IOCFG0           0x06      /*gdo0output pin configuration */
...
#define SMARTRF_SETTING_MDMCFG1          0x20      /*modem configuration*/
#define SMARTRF_SETTING_MDMCFG0          0x00      /*modem configuration */
