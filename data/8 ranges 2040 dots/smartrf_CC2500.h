...
#define SMARTRF_SETTING_FREQ2      0xC4 //0x5D	// Base freq: 2,400,000,000 / (Fxosc / 65536) = 5c4ec4
#define SMARTRF_SETTING_FREQ1      0x4E //0x93
#define SMARTRF_SETTING_FREQ0      0xC4 //0xB1
...
#define SMARTRF_SETTING_MDMCFG1    0x20 //0x22	// channel spacing exponent 0x03?
#define SMARTRF_SETTING_MDMCFG0    0x00 //0xF8  // Channel spacing: Fxosc/2^18 (~99.182) * (256*mantissa) ^ exp . Desired 333KHz.
